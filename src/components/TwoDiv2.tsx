import left from "../assets/TwoDiv_left.png"
import right from "../assets/TwoDiv_right.png"
export const TwoDiv2=()=>{
    return <div className="TwoDiv">
        <div className="TwoDiv_base">
            
            <img className="hero_image" src={left} alt="image" />
        ...
        <div className="TwoDiv_base_2">
             <img className="hero_image_right" src={right} alt="image" />
            
            {/*the text in blue with png */}
            <div className="TwoDiv_png_text_container_2">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
